...
import anvilIcon      from '/icons/anvil.svg?url'
import batteryIcon     from '/icons/battery.svg?url'
import computerIcon       from '/icons/computer.svg?url'
import geneIcon     from '/icons/gene.svg?url'
import penIcon from '/icons/pen.svg?url'
import wheelIcon from '/icons/wheel.svg?url'
import radioIcon from '/icons/radio.svg?url'
import bulbIcon from '/icons/bulb.svg?url'
import fireIcon       from '/icons/fire.svg?url'
import flaskIcon   from '/icons/flask.svg?url'
import globeIcon    from '/icons/globe.svg?url'
import factoryIcon      from '/icons/factory.svg?url'
import cornIcon        from '/icons/corn.svg?url'
import scrollIcon from '/icons/scroll.svg?url'
